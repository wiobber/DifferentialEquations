...
\addplot[smooth, thick, dashed, blue] {1}
...
\begin{tikzpicture}[scale=1]
  ...
  \draw[-, line width=2pt, black] (3,0) -- (3,5);
\draw[black, fill=gray] (3,5) circle(0.4);
\draw[black, fill=gray] (-3,-3) circle(0.4);
   \draw[-, dashed, gray] (0,-3.5) -- (0,5.5);
   \node at (-3, -4.5) {(a) Stable equilibrium};
   \node at (3, -4.5) {(b) Unstable equilibrium};
   \draw[black] (-3,2) circle(0.1);
 \draw[black] (3,0) circle(0.1);
\end{tikzpicture}
\end{center} 
