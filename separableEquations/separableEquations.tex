...
$\eqref{eq:2.2.10}$, we say that $\eqref{eq:2.2.11}$ is an \dfn{
implicit solution of the initial value problem} $\eqref{eq:2.2.12}$. However, keep these points in mind:
\begin{itemize}
...
% this doesn't add much... Although more than one differentiable function $y=y(x)$ satisfies
%$\ref{eq:2.2.13}$) near $x=1$, i
It can be shown there is only one such function that satisfies the initial condition $y(2)=1.$
% I presumed this was a typo:  $y(1)=2$.
