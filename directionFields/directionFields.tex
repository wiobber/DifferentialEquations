...
Given a differential equation such as $y'=x+y$, it is easy to find an explicit solution.  (You may want to verify that functions of the form $y=ce^x-x-1$ are solutions.)  However, it is impossible or impractical to find explicit formulas for solutions of many differential equations. In such cases we may resort to
...
The figures in the three examples below show direction fields and solution
